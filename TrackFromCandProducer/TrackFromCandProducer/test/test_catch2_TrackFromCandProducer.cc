...
static constexpr auto s_tag = "[TrackFromCandProducer]";

TEST_CASE("Standard checks of TrackFromCandProducer", s_tag) {
  const std::string baseConfig{
R"_(from FWCore.TestProcessor.TestProcess import *
process = TestProcess()
process.toTest = cms.EDProducer("TrackFromCandProducer"
