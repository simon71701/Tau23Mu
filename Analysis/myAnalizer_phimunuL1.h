#ifndef myAnalizer_phimunuL1_h
#define myAnalizer_phimunuL1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   myAnalizer_phimunuL1(TTree *tree, TString fname);
   virtual ~myAnalizer_phimunuL1();
...
#ifdef myAnalizer_phimunuL1_cxx
myAnalizer_phimunuL1::myAnalizer_phimunuL1(TTree *tree, TString fname) : fChain(0)
{
   Init(tree);
   fileName=fname;
}

myAnalizer_phimunuL1::~myAnalizer_phimunuL1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t myAnalizer_phimunuL1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t myAnalizer_phimunuL1::LoadTree(Long64_t entry)
{
...
void myAnalizer_phimunuL1::Init(TTree *tree)
{
...
Bool_t myAnalizer_phimunuL1::Notify()
{
...
void myAnalizer_phimunuL1::Show(Long64_t entry)
{
...
Int_t myAnalizer_phimunuL1::Cut(Long64_t entry)
{
...
#endif // #ifdef myAnalizer_phimunuL1_cxx
