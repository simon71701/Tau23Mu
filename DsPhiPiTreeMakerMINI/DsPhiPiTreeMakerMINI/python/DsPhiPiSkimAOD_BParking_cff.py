...
LeadingMuon = cms.EDFilter("PATMuonSelector",
                          src = cms.InputTag("PatMuons"),
                          cut = cms.string('pt > 7 &&  abs(eta)<2.4 && (innerTrack().isNonnull) && (charge!=0) && (innerTrack().hitPattern().numberOfValidPixelHits()>0)'),
                          filter = cms.bool(True)
)


LooseMuon = cms.EDFilter("PATMuonSelector",
                          src = cms.InputTag("PatMuons"),
...
LeadingMuonFilter = cms.EDFilter("CandViewCountFilter",
...
LooseMuonFilter= cms.EDFilter("CandViewCountFilter",
...
LooseTrack = cms.EDFilter("TrackSelector",
                             ...
                             cut = cms.string('pt > 1 &&  abs(eta)<2.4 &&  (charge!=0) && hitPattern().trackerLayersWithMeasurement()>5 && hitPattern().pixelLayersWithMeasurement()>=1'),
...
DiMuonCand  = cms.EDProducer("CandViewShallowCloneCombiner",
                              ...
                              decay = cms.string("LeadingMuon LooseMuon")
                              )
...
PlotsAfterLooseMuon = cms.EDAnalyzer('RecoMuonAnalyzer',
                                   muonsInputTag = cms.InputTag("LooseMuon"),
                                   )

PlotsAfterLeadingMuon = cms.EDAnalyzer('RecoMuonAnalyzer',
                                   muonsInputTag = cms.InputTag("LeadingMuon"),
                                   )
